...
class DAPPluginForm(PluginForm):
    ...
    def PopulateForm(self):
        ...
        self.parent.checkBox_ResumeAfterInjection.setCheckState(True)
        self.parent.checkBox_ResumeAfterInjection.setTristate(False)
